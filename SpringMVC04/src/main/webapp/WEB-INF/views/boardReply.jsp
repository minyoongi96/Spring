	    ...
	    <div class="panel-body">
	    	<form action="${cpath}/boardReply.do" method="post">
	    		...
	    		<table class="table table-bordered table-hover">
	    			<tr>
	    				<td>제목</td>
	    				<td><input type="text" name="title" class="form-control" value="${vo.title}" readonly="readonly"/></td>
	    			</tr>
	    			<tr>
	    				<td>작성자</td>
	    			...
	    			<tr>
	    				<td>내용</td>
	    				<td><textarea name="contents" rows="5" class="form-control" style="resize: none;"></textarea></td>
	    			</tr>
	    			<tr>
	    			<td colspan="2" align="right">
	    				<button type="submit" class="btn btn-primary btn-sm">등록</button>
	    				<button type="reset" class="btn btn-warning btn-sm" onclick="location.href='${cpath}/boardView.do?idx=${vo.idx}'">취소</button>
	    			</td>
	    			</tr>
	    		</table>
	    	</form>
